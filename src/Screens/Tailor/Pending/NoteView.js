    ...
    <View style={styles.container}>
      <View style={styles.group}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <Text style={styles.ref}>Additional Note</Text>
          <View style={styles.ImageView}>
            <Text style={styles.note}>
              I want silver cufflinks as against the gold in the reference
              pictures. Also please make the pockets as small as possible
            </Text>
          </View>
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  ImageView: {
    ...
    maxHeight: heightPercentageToDP('74.8%'),
    borderRadius: 8,
    padding: 10,
  },
